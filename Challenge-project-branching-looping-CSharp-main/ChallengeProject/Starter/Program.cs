                ...
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    for (int j = 0; j < 6; j++)
                    {
                        if (ourAnimals[i, j] == "Age: ?")
                        {
                            do
                            {
                                animalID = ourAnimals[i, 0].ToString();
                            ...
                            // store the petAge in the ourAnimals array
                            ourAnimals[i, j] = "Age: " + petAge;
                        }

                        if (ourAnimals[i, j] == "Physical description: ")
                        {
                            do
                            {
                                animalID = ourAnimals[i, 0].ToString();
                                Console.WriteLine($"Enter a physical description for {animalID} (size, colour, gender, weight, housebroken)");
                                readResult = Console.ReadLine();
                                if (readResult != null)
                                {
                                    animalPhysicalDescription = readResult.ToLower();
                            ...
                            // store the animalDescription in the ourAnimals array
                            ourAnimals[i, j] = "Physical description: " + animalPhysicalDescription;
                        }
                    }
                }
            }
                ...
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    for (int j = 0; j < 6; j++)
                    {
                        if (ourAnimals[i, j] == "Nickname: ")
                        {
                            ...
                            // store the animalNickname in the ourAnimals array
                            ourAnimals[i, j] = "Nickname: " + animalNickname;
                        }

                        if (ourAnimals[i, j] == "Personality: ")
                        {
                            do
                            {
                                animalID = ourAnimals[i, 0].ToString();
                            ...
                            // store the animalPersonalityDescription in the ourAnimals array
                            ourAnimals[i, j] = "Personality: " + animalPersonalityDescription;
                        }
                    }
                }
            }

            Console.WriteLine("\nNickname and personality description fields are complete for all our friends");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
